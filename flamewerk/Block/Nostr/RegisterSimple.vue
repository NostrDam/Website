<template>
    <div class="dark:text-white">
      ...
      <h1 class="text-2xl text-center"><IdentificationIcon class="h-10 w-10 mr-2 inline " />Register Keys</h1>

      <p class="text-center mb-6">{{ t("title") }} </p>
      ...
      <h1 class="text-2xl text-center mt-6"><KeyIcon class="h-6 w-6 mr-2 inline" /> Privatekey</h1>
      <BlockProseCopybox :copycontent="nsec" class="mx-auto" />


       <h1 class="text-2xl text-center mt-6"><GlobeEuropeAfricaIcon class="h-6 w-6 mr-2 inline" /> Publickey</h1>
      <BlockProseCopybox :copycontent="npub" class="mx-auto" />

      <p class="font-bold mt-6 text-center">{{ t("message") }}</p>
